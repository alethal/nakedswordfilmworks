...
<div class="PageContentWrap">
  ...
  <div class="small-12 columns">
     <!--<h1>The Layover - Contest</h1>--><div class="ContestText">
In the spirit of our new movie <em>The Layover</em> we want you to start your own sexy travel memories with a $200 voucher from Southwest Airlines! No purchase necessary! This contest is 100% free and open to residents of the USA <em>(One entry per person)</em>. Just enter your email address, first name, and last name - you could be the next passenger on board. Enjoy your flight!
  <br>
<br>
<span style="font-size: 3em; text-transform: uppercase;">Contest has Ended - Winner Announced Soon!</span>
	  </div>
    ...
    <div class="row">
      ...
      <div style="background-color:#ffffff; padding: 0 0 2em 0;">
      <img src="https://spotlight.nakedcdn.com/nakedsword/img/contest/thelayover/layober_contest_social_page5.jpg" width="100%">
      
      
      
      <!-- lyris - newsletter sign up 2x opt in -->
<!--	 

<div style="width: 75%; background-color:transparent; margin-left: auto; margin-right: auto;">
...
<input type="hidden" name="demographics" value="-1,1,2" />
...
<div class="ContestInputWrap"><input type='text' name='email' value=''  class="ContestInput" placeholder="YOUR EMAIL"></div>

<div class="ContestInputWrap"><input type='text' name="val_1" value=''  class="ContestInput" placeholder="FIRST NAME"></div>

<div class="ContestInputWrap"><input type='text' name="val_2" value=''  class="ContestInput" placeholder="LAST NAME"></div>


<BR><div class="SubmitWrap">
<input type="submit" name="SubmitButton" value="ENTER THE CONTEST" id="SubmitButton" class="SubmitBtn"></div>
</div></div>
...
-->
	  ...
	  <div class="text-center"><BR clear="all">&nbsp;<BR>
      <A HREF="/thelayovercontestterms">Click here for terms and conditions</A>
		  </div>
