...
<%--ns:PageBouncer runat="server" 
    ID="MembersOnlyBouncerGreasers" 
    ShowForCustomerProfile="SignedIn" 
    BounceToUrl="~/greasers"
    /--%>
...
<%-- turns off when scene 1 goes live --%>
    <ns:ContentInclude runat="server"
        id="GreasersTilLive"
        FallbackContentUrl="~/content/static_movie_folder/greasers/members_teaser/hide_members_teaser.html"
        ShowForCustomerProfile="ActiveMember"
        ShowContentUrl="~/content/static_movie_folder/greasers/members_teaser/members_teaser.html"
        ScheduleStart="2016-12-26T09:01:00"
        ScheduleEnd="2017-01-04T09:01:00"
         />
...
<%-- Movie --%>
<nsf:MovieDetail id="Movie" MovieID="208465" runat="server" /> 
